...
<script>
  ...
  const locations = [
    "조원 한 명이 안대 착용 후 다른 조원들의 안내를 따라 갈라디아서 2장 16절 말씀 퍼즐을 완성하시오.",
    "사진참고하여 도미노 하트를 만들어 영상을 촬영하시오.",
    "간수와 바울 역할극을 촬영하여 영상을 업로드 하시오.",
    "사명, 소망 선언문을 작성하시오.",
    "에베소서 2장 8~9절을 조원들이 나누어서 암송하시오.",
    "하트 풍선을 찾고 비밀장소를 찾아 단체 사진을 찍으세요. 하트풍선 총 12개 1층 2개 2층 2개 3층 3개 4층5개"
  ];
